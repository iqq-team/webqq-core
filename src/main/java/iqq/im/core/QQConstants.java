...
public interface QQConstants {
    ...
    public static final String VREFFER = "http://s.web2.qq.com/proxy.html?v=20130916001&callback=1&id=1";
    /**
    ...
    public static final String URL_GET_VFWEBQQ = "http://s.web2.qq.com/api/getvfwebqq";
